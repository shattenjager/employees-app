...
public class EmployeeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (action!=null){
            switch (action) {           
            case "searchById":
                searchEmployeeById(req, resp,employeeService);
                break;           
            case "searchByName":
                searchEmployeeByName(req, resp,employeeService);
                break;
            }
        }else{
    ...
    private void searchEmployeeById(HttpServletRequest req, HttpServletResponse resp, EmployeeService employeeService)
    ...
    private void searchEmployeeByName(HttpServletRequest req, HttpServletResponse resp, EmployeeService employeeService)
            throws ServletException, IOException {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        switch (action) {
            case "add":
                addEmployeeAction(req, resp, employeeService);
                break;
            case "edit":
                editEmployeeAction(req, resp, employeeService);
                break;            
            case "remove":
                removeEmployeeByName(req, resp, employeeService);
                break;            
        }

    }

    private void addEmployeeAction(HttpServletRequest req, HttpServletResponse resp, EmployeeService employeeService)
            throws ServletException, IOException {
    ...
    private void editEmployeeAction(HttpServletRequest req, HttpServletResponse resp, EmployeeService employeeService)
            throws ServletException, IOException {
        String name = req.getParameter("name");
        String lastName = req.getParameter("lastName");
        String birthday = req.getParameter("birthDate");
        ...
        String email = req.getParameter("email");
        long idEmployee = Integer.valueOf(req.getParameter("idEmployee"));
        Employee employee = new Employee(idEmployee, name, lastName, birthday, role, department, email);
    ...
    private void removeEmployeeByName(HttpServletRequest req, HttpServletResponse resp, EmployeeService employeeService)
            throws ServletException, IOException {
        long idEmployee = Integer.valueOf(req.getParameter("idEmployee"));
